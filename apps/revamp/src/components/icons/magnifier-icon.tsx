    ...
    >
      ...
      <g fill="none" className="nc-icon-wrapper">
        <path
          ...
          fill="url(#b6l53yboxt-1752500502796-6054278_magnifier_existing_0_gpzbpr1b3)"
          data-glass="origin"
          mask="url(#b6l53yboxt-1752500502796-6054278_magnifier_mask_u1j50qeck)"
        ></path>
        <path
          d="M10.586 10.5859C11.3671 9.80486 12.6331 9.80486 13.4142 10.5859L21.9142 19.0859L22.0519 19.2373C22.6926 20.0228 22.6464 21.1818 21.9142 21.914C21.1819 22.6463 20.0229 22.6925 19.2374 22.0517L19.086 21.914L10.586 13.414C9.80498 12.633 9.80498 11.367 10.586 10.5859Z"
          fill="url(#b6l53yboxt-1752500502796-6054278_magnifier_existing_0_gpzbpr1b3)"
          data-glass="clone"
          filter="url(#b6l53yboxt-1752500502796-6054278_magnifier_filter_u6qjvmab1)"
          clipPath="url(#b6l53yboxt-1752500502796-6054278_magnifier_clipPath_k96ejzfu8)"
        ></path>
        <path
          ...
          fill="url(#b6l53yboxt-1752500502796-6054278_magnifier_existing_1_82nwa6xrf)"
          data-glass="blur"
        ></path>
        <path
          ...
          fill="url(#b6l53yboxt-1752500502796-6054278_magnifier_existing_2_8ve8k2etb)"
        ></path>
        <defs>
          <linearGradient
            id="b6l53yboxt-1752500502796-6054278_magnifier_existing_0_gpzbpr1b3"
            x1="16.25"
            y1="10"
            x2="16.25"
            y2="22.5"
          ...
          <linearGradient
            id="b6l53yboxt-1752500502796-6054278_magnifier_existing_1_82nwa6xrf"
            x1="10"
            y1="1.5"
            x2="10"
            y2="18.5"
          ...
          <linearGradient
            id="b6l53yboxt-1752500502796-6054278_magnifier_existing_2_8ve8k2etb"
            x1="10"
            y1="1.5"
            x2="10"
            y2="11.345"
          ...
          <filter
            id="b6l53yboxt-1752500502796-6054278_magnifier_filter_u6qjvmab1"
            x="-100%"
            y="-100%"
            width="400%"
            height="400%"
          ...
          <clipPath id="b6l53yboxt-1752500502796-6054278_magnifier_clipPath_k96ejzfu8">
            <path
              d="M18.5 10C18.5 14.6943 14.6943 18.5 10 18.5C5.30567 18.5 1.5 14.6943 1.5 10C1.5 5.30567 5.30567 1.5 10 1.5C14.6943 1.5 18.5 5.30567 18.5 10Z"
              fill="url(#b6l53yboxt-1752500502796-6054278_magnifier_existing_1_82nwa6xrf)"
            ></path>
          </clipPath>
          <mask id="b6l53yboxt-1752500502796-6054278_magnifier_mask_u1j50qeck">
